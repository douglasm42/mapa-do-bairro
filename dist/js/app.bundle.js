...
exports.places = undefined;

var _places_container = __webpack_require__(40);
...
var places = exports.places = new _places_container2.default();
...
var _places_data = __webpack_require__(7);
...
var Map = function () {
  ...
  _createClass(Map, [{
    ...
    value: function init() {
      ...
      this.places.allPlaces.forEach(function (p) {
        var marker = new _marker2.default(p);
        marker.show(_this);
      });
    ...
    value: function filterMarkers() {
      ...
      if (this.loaded) {
        ...
        this.places.filteredPlaces.forEach(function (p) {
          p.marker.show(_this2);
        });
      } else {
    ...
    key: 'panToPosition',
    value: function panToPosition(position) {
      if (this.loaded) {
    ...
    key: 'panToPlaces',
    value: function panToPlaces() {
      if (this.loaded) {
        var filteredPlaces = this.places.filteredPlaces;
...
var map = exports.map = new Map(goiania, 14, _places_data.places);
...
if (app) {
  _reactDom2.default.render(_react2.default.createElement(_layout2.default, { places: _places_data.places, map: _map.map }), app);
}
...
var _map_container = __webpack_require__(35);
...
var _details = __webpack_require__(42);
...
var Layout = function (_Component) {
  ...
  _createClass(Layout, [{
    ...
    value: function showDetails(place) {
      ...
      var prevPlace = this.state.detailedPlace;
      ...
      setTimeout(function () {
        return map.panToPosition(place.position);
      }, 200);
    }
    ...
    value: function render() {
      ...
      if (this.state.loaded) {
        sidebar = _react2.default.createElement(_sidebar2.default, {
        ...
        details = _react2.default.createElement(_details2.default, {
      ...
      return _react2.default.createElement(
        'section',
        { className: 'container' },
        _react2.default.createElement(_header2.default, { onSideBarToggle: this.onSideBarToggle }),
        sidebar,
...
var _sidebar_toggle = __webpack_require__(30);

var _sidebar_toggle2 = _interopRequireDefault(_sidebar_toggle);
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'header',
        { className: 'topbar' },
        _react2.default.createElement(_sidebar_toggle2.default, { onToggle: this.props.onSideBarToggle }),
...
var SideBarToggle = function (_Component) {
  _inherits(SideBarToggle, _Component);

  function SideBarToggle() {
    _classCallCheck(this, SideBarToggle);

    return _possibleConstructorReturn(this, (SideBarToggle.__proto__ || Object.getPrototypeOf(SideBarToggle)).apply(this, arguments));
  }
  ...
  _createClass(SideBarToggle, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        "a",
        { href: "#", className: "menu", onClick: this.props.onToggle },
        "\u2630"
      );
    }
  }]);
...
var _sidebar_filter = __webpack_require__(32);

var _sidebar_filter2 = _interopRequireDefault(_sidebar_filter);

var _sidebar_list = __webpack_require__(33);

var _sidebar_list2 = _interopRequireDefault(_sidebar_list);
...
var SideBar = function (_Component) {
  ...
  _createClass(SideBar, [{
    ...
    key: 'render',
    value: function render() {
      var hide = this.props.show ? ' sidebar-show' : ' sidebar-hide';
      return _react2.default.createElement(
        'nav',
        { className: 'sidebar' + hide },
        _react2.default.createElement(_sidebar_filter2.default, { handleChange: this.handleFilterChange }),
        _react2.default.createElement(_sidebar_list2.default, {
  ...
  _createClass(SideBarFilter, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement("input", { className: "filter", type: "text", placeholder: "Busca", onChange: this.handleChange })
      );
    }
  }]);
...
var _sidebar_item = __webpack_require__(34);
...
var SideBarList = function (_Component) {
  _inherits(SideBarList, _Component);

  function SideBarList() {
    _classCallCheck(this, SideBarList);

    return _possibleConstructorReturn(this, (SideBarList.__proto__ || Object.getPrototypeOf(SideBarList)).apply(this, arguments));
  }
  ...
  _createClass(SideBarList, [{
    ...
    value: function render() {
      ...
      // filtrada de lugares.
      var map = this.props.map;
      var places = this.props.places.filteredPlaces.map(function (item) {
        return _react2.default.createElement(_sidebar_item2.default, {
          key: item.id.toString(),
          place: item,
          map: map,
          onSelect: _this2.props.onSelectPlace
        });
      });
  ...
  _createClass(SideBarItem, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'a',
          { className: 'place-link', href: '#', onClick: this.handleClick },
...
var MapContainer = function (_Component) {
  ...
  _createClass(MapContainer, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'article',
        { className: 'map-container' + (this.props.small ? ' map-container-small' : '') },
        _react2.default.createElement(
          'div',
          { id: 'map' },
          'Carregando...'
...
var _markerRed = __webpack_require__(38);

var _markerRed2 = _interopRequireDefault(_markerRed);

var _markerBlue = __webpack_require__(39);

var _markerBlue2 = _interopRequireDefault(_markerBlue);
...
var Marker = function () {
  ...
  _createClass(Marker, [{
    ...
    value: function setClickListener(f) {
      this.handleClick = f;
    }
...
module.exports = "img/marker-red.png";

/***/ }),
/* 39 */
/***/ (function(module, exports) {

module.exports = "img/marker-blue.png";
...
var PlacesContainer = function () {
  ...
  _createClass(PlacesContainer, [{
    ...
    value: function applyFilter(filter) {
      ...
      this.filteredPlaces = this.allPlaces.filter(function (item) {
        return item.name.toLowerCase().includes(_this.filter);
      });
    }
...
var _details_close = __webpack_require__(43);

var _details_close2 = _interopRequireDefault(_details_close);

var _details_body = __webpack_require__(44);

var _details_body2 = _interopRequireDefault(_details_body);
    ...
    value: function render() {
      ...
      if (place) {
        header = _react2.default.createElement(
          ...
          _react2.default.createElement(_details_close2.default, { onClose: this.props.onClose })
        );

        body = _react2.default.createElement(_details_body2.default, { place: place });
      }
      var hide = this.props.place ? '' : ' details-hide';
...
var DetailsClose = function (_Component) {
  _inherits(DetailsClose, _Component);

  function DetailsClose() {
    _classCallCheck(this, DetailsClose);

    return _possibleConstructorReturn(this, (DetailsClose.__proto__ || Object.getPrototypeOf(DetailsClose)).apply(this, arguments));
  }

  _createClass(DetailsClose, [{
    key: "render",
    value: function render() {
      return _react2.default.createElement(
        "a",
        { href: "#", className: "details-close", onClick: this.props.onClose },
        "\xD7"
      );
    }
  }]);
...
var DetailsBody = function (_Component) {
  _inherits(DetailsBody, _Component);

  function DetailsBody(props) {
    _classCallCheck(this, DetailsBody);
